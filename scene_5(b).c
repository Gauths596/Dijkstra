...
glPopMatrix();
 ...
 //----------Defining----------
  glPushMatrix();
  glTranslatef(700,-1800,0);
   glTranslatef(-0.5,xpos,0.7);
  glScalef(0.4,0.4,0);
  glLineWidth(3);
  glColor3f(0,0,0);
  if(xpos>1800 && xpos<1900 ){
 ...
 glEnd();
  ...
  else if(xpos>120 && xpos<=300){
         glTranslatef(190,1250,0);
        glTranslatef(xpos,-xpos,1.6);
      glRotatef(-45,0,0,1);
  }

  else if(xpos>300 && xpos<=1300)
  {
  ...
  else if(xpos>1300 && xpos<=1750)
  {
      glTranslatef(1650,-1300,0);
      glTranslatef(xpos,xpos,0.7);
      glRotatef(45,0,0,1);
  }

  else if(xpos>1750 && xpos<=1900)
  {
       glTranslatef(1700,800,0);
      glTranslatef(xpos,-0.5,0.7);
      glRotatef(0,0,0,1);
